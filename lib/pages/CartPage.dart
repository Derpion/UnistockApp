          ...
          content: Container(
            ...
            child: SingleChildScrollView(
              child: Text(
                ...
                '3. Accuracy of Information: You are responsible for providing accurate information during the reservation process (e.g., item, size, quantity). UniStock will not be liable for errors caused by incorrect user inputs.\n\n'
                ...
                '5. Changes to Terms: UniStock reserves the right to modify these terms and conditions at any time without prior notice. Users are encouraged to review the terms periodically.\n\n'
                '6. Data Privacy: Your personal information will be handled in accordance with our Privacy Policy. By using the app, you acknowledge that your information will be collected, stored, and used to process reservations and send you alerts.\n\n',
