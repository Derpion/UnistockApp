...
import 'package:UNISTOCK/services/DetailSelectionPro.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class ProwareUniSelectionPage extends StatefulWidget {
  final String courseLabel;
  final ProfileInfo currentProfileInfo;

  ProwareUniSelectionPage({
    required this.currentProfileInfo,
    required this.courseLabel,
  });

  @override
  _ProwareUniSelectionPageState createState() =>
      _ProwareUniSelectionPageState();
}

class _ProwareUniSelectionPageState extends State<ProwareUniSelectionPage> {
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => DetailSelectionPro(
              itemId: id,
